...
var BS, Controller, View, View_Episode, View_EpisodeComments, View_Menu, View_MyEpisodes, View_Show, menu,
  __slice = [].slice,
...
BS = View_Show = (function(_super) {
  ...
  View_Show.prototype.init = function(url) {
    this.id = 'showsDisplay.' + url;
    this.url = '/shows/display/' + url;
    return this.show = url;
  };

  View_Show.prototype.name = 'showsDisplay';
