/*! nanoScrollerJS - v0.7.5 - (c) 2013 James Florentino; Licensed MIT */ ! function(a, b, c) {
  "use strict";
  ...
  x = {
    ...
    return i.prototype.preventScrolling = function(a, b) {
      ...
      return this.isActive ? (this.sliderY = Math.max(0, this.sliderY), this.sliderY = Math.min(this.maxSliderTop, this.sliderY), this.$content.scrollTop(-1 * ((this.paneHeight - this.contentHeight + e) * this.sliderY / this.maxSliderTop)), this.iOSNativeScrolling || this.setOnScrollStyles(), this) : void 0
      ...
      return w && w(this.scrollRAF), this.stopped = !0, this.removeEvents(), this.iOSNativeScrolling || this.pane.hide(), this
